...
class GoldenList:
    ...
    def generate_lists(self, user_id, data_path="/datasets/ml-latest-small", ds_ratings=None, min_rating=4.0,
                       num_of_recs=20, p_thresh=5, u_thresh=5, verbose=False, lfm_metric="warp", norm_func=None):
